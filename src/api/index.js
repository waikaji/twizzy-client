...
export const fetchQuizesBySearch = (searchQuery) => API.get(`/quizes/search?searchQuery=${searchQuery.search || "none"}`);
export const fetchUserQuizes = (id) => API.get(`/quizes/user/${id}`);
